...
//   filterContainer = 'gallery__filter';

//   // look for any elements with the class 'gallery__filter':
...
//     filterElement[iFilterElement].appendChild(filterSelected);
...
//       // set 'filter__item--selected' class for the first element in the list:
//       if (iFilterItem == 0) {
...
//         var y, i, k, selectElement, h, lSelectElement, yl;
...
//       e.stopPropagation();
//       closeAllSelect(this);
//       this.nextSibling.classList.toggle('filter__list--hidden');
//       // this.classList.toggle('filter__icon--active');
